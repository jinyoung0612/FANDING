...
const FundingDetails = (props) => {
  ...
  const funding = useSelector(
    ({ firestore: { data } }) => data.fundings && data.fundings[doc_id]
  );
  const user = useSelector(
    ({ firestore: { data } }) => data.users && data.users[user_email]
  );
  ...
  const auth_list = [
    { label: "streamingImage", value: "스트리밍 인증" },
  ...
  const handleSubmit_riss = async (funding) => {
  ...
  if (funding && firebase.auth().currentUser) {
      ...
      return (
        ...
        >
          <Container>
            ...
            >
              {funding.artistSelect}
            </Button>
            <div className="text-left">
              <h2>
                <b>{funding.fundingTitle}</b>
              </h2>
            </div>
            <div>
                ...
                <Col xs="12" sm="12" md="4">
                  <div>
                    <div
                      ...
                      style={{ fontSize: "1.5em", paddingTop: "30px" }}
                    >
                      <b>{percent}% 달성</b>
                    </div>
                    <ProgressBar
                    ...
                    {funding.isClosed === true ? (
                      ...
                      <Row xs="2">
                        ...
                        <Col>
                          <Button onClick={HandleClose}>펀딩 마감하기</Button>
                        </Col>
                      </Row>
                    ) : (
                      <Row xs="2">
                      ...
                      <Form>
                        ...
                        <ModalBody>
                          <div className="companyRecruit text-center">
                            <h3>
                              [{funding.artistSelect}]{funding.fundingTitle}
                            </h3>
                            <FormGroup>
                            ...
                            <ModalFooter>
                              <Button
                                color="primary"
                                onClick={() => {
                                  handleSubmit_riss(funding);
                                }}
                              >
                                제출하기
                              </Button>{" "}
                              <Button color="secondary" onClick={modalClosed}>
                                닫기
                              </Button>
                            </ModalFooter>
                          </div>
                      ...
                      <Col>
                        {like === true ? (
                          <Button
                            ...
                            size="xs"
                            onClick={(e) => handleDislike(e, funding)}
                            block
                          >
                          ...
                          <Button
                            ...
                            size="xs"
                            onClick={(e) => handleLike(e, funding)}
                            block
                          >
                        ...
                        <Link to={"../../totalchat"}>
                          <Col>
                            <Button
                              ...
                              block
                            >
                              <BsChatSquareDots className="mr-2" /> 문의
                            </Button>
                          </Col>
                        </Link>
                      ) : (
                    ...
                    <Row xs="2">
                      <Col xs="12">
                        ...
                        >
                          ...
                          >
                            NOTICE <BsFillBellFill className="ml-2 mb-20" />
                          </Button>
                        </Link>
                      </Col>
                    </Row>
              ...
              <Row xs="3" style={{ paddingTop: "50px" }}>
                <Col xs={12} sm={12} md={8}>
                  <CardText>
                    <CardText>
                      <b style={{ fontSize: "1.5em" }}>펀딩 기간(입금 기간)</b>
                    </CardText>
                    <CardText style={{ marginBottom: "20px" }}>
                      {funding.fundingStartDate} {funding.fundingStartTime} ~{" "}
                      {funding.fundingEndDate} {funding.fundingEndTime}
                    </CardText>
                    <CardText>
                      <b style={{ fontSize: "1.5em" }}>펀딩달성기준</b>
                    </CardText>
                    <CardText style={{ marginBottom: "20px" }}>
                      {funding.itemRemain}명
                    </CardText>
                    <CardText>
                      <b style={{ fontSize: "1.5em" }}>품목</b>
                    </CardText>
                    <CardText style={{ marginBottom: "20px" }}>
                      {funding.itemTitle}
                    </CardText>
                    <CardText>
                      <b style={{ fontSize: "1.5em" }}>가격</b>
                    </CardText>
                    <CardText style={{ marginBottom: "20px" }}>
                      {funding.itemPrice}원
                    </CardText>
                    <CardText>
                      <b style={{ fontSize: "1.5em" }}>입금 계좌</b>
                    </CardText>
                    {funding.isClosed === true ? (
                      <CardText>
                        마감된 펀딩의 입금 계좌는 볼 수 없습니다.
                      </CardText>
                    ) : (
                      <CardText style={{ marginBottom: "20px" }}>
                        {funding.bankName} {funding.accountNum}{" "}
                        {funding.accountName}
                      </CardText>
                    )}
                    <CardText>
                      <b style={{ fontSize: "1.5em" }}>배송방법</b>
                    </CardText>
                    <CardText style={{ marginBottom: "20px" }}>
                      {funding.shippingMethod}
                    </CardText>
                    <CardText>
                      <b style={{ fontSize: "1.5em" }}>배송비</b>
                    </CardText>
                    <CardText style={{ marginBottom: "20px" }}>
                      {funding.shippingFee}
                    </CardText>
                    <CardText>
                      <b style={{ fontSize: "1.5em" }}>배송 안내</b>
                    </CardText>
                    <CardText style={{ marginBottom: "20px" }}>
                      {funding.shippingDetail}
                    </CardText>
                  </CardText>
                ...
                <Col xs={12} sm={12} md={4}>
                  <div className="text-left" style={{ marginTop: "0px" }}>
                    <h4 className="mt-30">
                      <b>업체 정보</b>
                    </h4>
                  </div>
                  {funding.selectedCom ? (
                    ...
                    >
                      업체 이름 {funding.selectedCom.label}
                    </div>
                  ) : (
                    <div
                      style={{
              ...
              <Row xs="3" style={{ paddingTop: "50px" }}>
                <Col xs={12} sm={12} md={8}>
                  <CardText>
                    ...
                    <CardText>
                      <b style={{ fontSize: "1.5em" }}>펀딩달성금액</b>
                    </CardText>
                    <CardText style={{ marginBottom: "20px" }}>
                      {funding.itemRemain}
                    </CardText>
                    ...
                    {funding.gift === true ? (
                      <div>
                        <CardText>
                          <b style={{ fontSize: "1.5em" }}>특전 배송 안내</b>
                        </CardText>
                        <CardText style={{ marginBottom: "20px" }}>
                          {funding.shippingDetail}
                        </CardText>
    ...
    if (props.auth.isLoaded && funding) {
      ...
      const difference =
        new Date(funding.fundingEndDate) - currentDate.getTime();
