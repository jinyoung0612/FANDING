        ...
        if(this.state.fundingType==="reward"){
            return (
                <>
                    ...
                    <Form inline>
                        ...
                        <FormGroup>
                            <Label for="itemRemain">목표 수량</Label>
            ...
            return (
                <>
                    ...
                    <Label for="itemInfo">모금 정보</Label>
                    <Form inline>

                        <FormGroup>
                            <Label for="itemRemain">목표 금액</Label>
                            <Input type="text" name="title" id="itemRemain" placeholder="" onChange={this.handleChange}/>
                        </FormGroup>
                  </Form>
                    ...
                    <Form inline>
                        <FormGroup>
                            <CustomInput type="checkbox" id="gift" value = "gift" name="customRadio" label="특전 있음"
                    ...
                    <Form>
                        {this.state.gift===true ?  <FormGroup>
                            <Label for="shippingDetail">특전 배송 안내</Label>
                            <Input type="textarea" name="text" id="shippingDetail"
                                   onChange={this.handleChange}
                            />
                        </FormGroup> : null}
