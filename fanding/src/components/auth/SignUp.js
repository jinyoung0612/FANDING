            ...
            <AccordionDetails>
              <div style={AgreedStyle}>
                <Typography color="textSecondary">
                  ...
                  4) 팬딩을 이용하여 법령과 본 약관이 금지하는 행위를 하는 경우
                  <br></br>
                  ...
                  않습니다. 단, 전기통신기본법 등 법률의 규정에 의해 국가기관의
                  요구가 있는 경우, 범죄에 대한 수사상의 목적이 있거나
                  정보통신윤리 위원회의 요청이 있는 경우 또는 기타 관계법령에서
                  정한 절차에 따른 요청이 있는 경우, 귀하가 팬딩에 제공한
                  개인정보를 스스로 공개한 경우에는 그러하지 않습니다.
                  <br></br>
                  2) 개인정보의 관리 : 귀하는 개인정보의 보호 및 관리를 위하여
                  서비스의 개인정보관리에서 수시로 귀하의 개인정보를 수정/삭제할
                  수 있습니다.
                  <br></br>
                  3) 개인정보의 보호 : 귀하의 개인정보는 오직 귀하만이
                  열람/수정/삭제 할 수 있으며, 이는 전적으로 귀하의 ID와
                  비밀번호에 의해 관리되고 있습니다. 따라서 타인에게 본인의 ID와
                  비밀번호를 알려주어서는 안되며, 작업 종료 시에는 반드시
                  로그아웃 해주시기 바랍니다.
                  <br></br>
                  3. 회원이 본 약관에 따라 이용신청을 하는 것은, 팬딩이 신청서에
                  기재된 회원정보를 수집, 이용하는 것에 동의하는 것으로
                  간주됩니다.
                  <br></br>
                  ...
                  비밀번호를 사용하여 발생하는 모든 결과에 대한 책임은 회원
                  본인에게 있습니다.
                  <br></br>
                  ...
                  <br></br>
                  <br></br>
                  1. 팬딩은 귀하가 서비스를 이용하여 기대하는 손익이나 서비스를
                  ...
                  권리를 보유하며, 게시판 운영원칙에 따라 사전 통지 없이 삭제할
                  수 있습니다.
                  <br></br>
                  3. 귀하의 게시물이 타인의 저작권을 침해함으로써 발생하는 민,
                  형사상의 책임은 전적으로 귀하가 부담하여야 합니다.
                  <br></br>
                  4. 팬딩이 작성한 저작물에 대한 저작권 기타 지적재산권은 팬딩에
                  귀속합니다.
                  <br></br>
                  ...
                  <br></br>
                  <br></br>
                  팬딩은 본 서비스상에 게재되어 있거나 본 서비스를 통한 광고주의
                  판촉활동에 회원이 참여하거나 교신 또는 거래의 결과로서
                  발생하는 모든 손실 또는 손해에 대해 책임을 지지 않습니다.
                  <br></br>
                  <br></br>제 3 장 의무 및 책임
                  <br></br>
                  <br></br>제 12 조 (팬딩의 의무)
                  ...
                  <br></br>
                  <br></br>
                  1. 회원 가입 시에 요구되는 정보는 정확하게 기입하여야 합니다.
                  ...
                  <br></br>
                  <br></br>
                  1. 회원이 서비스의 이용권한, 기타 이용계약 상 지위를 타인에게
                  양도, 증여할 수 없습니다.
                  <br></br>
                  <br></br>제 15 조 (손해배상)
                  <br></br>
            ...
            <AccordionDetails>
              <div style={AgreedStyle}>
                <Typography text-overflow="auto" color="textSecondary">
                  ...
                  서비스 부정이용 방지, 각종 고지·통지, 고충처리, 분쟁 조 정을
                  ...
                  라. 마케팅 및 광고에의 활용
                  <br></br>
                  신규 서비스(제품) 개발 및 맞춤 서비스 제공, 접속빈도 파악 또는
                  ...
                  동의일로부터 탈퇴시까지 위 이용목적을 위하여 보유.이용됩니다.
                  <br></br>
                  -보유근거 : 표준 개인정보 보호지침
                  <br></br>
                  ...
                  5. 개인정보처리 위탁
                  <br></br>
                  <br></br>① 팬딩은 원칙적으로 이용자의 동의없이 해당 개인정보의
                  처리를 타인에게 위탁하지 않습니다. 다만, 이용자의 동의를 받아
                  팬딩이 현재 개인정보 처리를 위탁
                  <br></br>
                  하는 사항은 다음과 같습니다.
                  <br></br>
                  ...
                  <br></br>
                  이에 대해 지체 없이 조치하겠습니다.
                  <br></br>③ 제1항에 따른 권리 행사는 정보주체의 법정대리인이나
                  위임을 받은 자 등 대리인을 통하여 하실 수 있습니다. 이 경우
                  개인정보 보호법 시행규칙 별지 제11호 서식에 따른 위임장을 제출
                  <br></br>
                  하셔야 합니다.
                  <br></br>④ 개인정보 열람 및 처리정지 요구는 개인정보보호법
                  제35조 제5항, 제37조 제2항에 의하여 정보주체의 권리가 제한 될
                  수 있습니다.
                  ...
                  <br></br>
                  (1)제화 또는 서비스 제공
                  <br></br>- 필수항목 : 이메일, 비밀번호, 로그인ID, 이름, 별명,
                  휴대폰번호, 주소
                  <br></br>
                  <br></br>
                  ...
                  저장된 후 혹은 즉시 파기됩니다. 이 때<br></br>, DB로 옮겨진
                  ...
                  해당 서비스의 폐지, 사업의 종료 등 그 개인정보가 불필
                  <br></br>
                  ...
                  사용합니다. ② 쿠키는 웹사이트를 운영하는데 이용되는 서버(http)
                  <br></br>가 이용자의 컴퓨터 브라우저에게 보내는 소량의
                  정보이며 이용자들의 PC 컴퓨터내의 하드디스크에 저장되기도
                  합니다. 가. 쿠키의 사용 목적 : 이용자가 방문한 각 서비스와 웹
                  사이트들
                  <br></br>에 대한 방문 및 이용형태, 인기 검색어, 보안접속 여부,
                  등을 파악하여 이용자에게 최적화된 정보 제공을 위해 사용됩니다.
                  나. 쿠키의 설치•운영 및 거부 : 웹브라우저 상단의 도구-인터
                  <br></br>넷 옵션-개인정보 메뉴의 옵션 설정을 통해 쿠키 저장을
